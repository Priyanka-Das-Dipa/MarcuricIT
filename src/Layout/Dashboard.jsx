    ...
    <div className="flex">
      <div className="w-64 min-h-screen bg-black text-slate-100 px-5">
        ...
        <ul className="mt-6 space-y-1">
          <li>
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              ...
              <ul className="mt-2 space-y-1 px-4">
                ...
                <li className="flex gap-2 items-center">
                  <FaRegCircle />
                  <NavLink to="/admin/accounting_report">
                    Accounting Report
                  </NavLink>
                </li>
                <li className="flex gap-2 items-center">
          ...
          <li className="block rounded-lg text-white hover:bg-gray-100 hover:text-gray-700 px-4 py-2 text-sm font-medium ">Income Categories</li>
          <li className="block rounded-lg text-white hover:bg-gray-100 hover: px-4 py-2 text-sm font-medium ">Income</li>
          <li className="block rounded-lg text-white hover:bg-gray-100 hover: px-4 py-2 text-sm font-medium ">Contractor Reports</li>
          <li className="block rounded-lg text-white hover:bg-gray-100 hover: px-4 py-2 text-sm font-medium ">Summary</li>
        </ul>
      </div>
